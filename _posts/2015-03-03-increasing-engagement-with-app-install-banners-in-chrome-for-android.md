...
<img src="{% asset_path 2015-03-03/app-install-banner-io.png %}" width="253" height="450" />
<img src="{% asset_path 2015-03-03/app-install-banner-qr.png %}" width="253" height="450" />
...
* You have a [web app manifest file](http://updates.html5rocks.com/2014/11/Support-for-installable-web-apps-with-webapp-manifest-in-chrome-38-for-Android) 
  ...
  \`144x144\` png icon.
* You have a [service worker](http://www.html5rocks.com/en/tutorials/service-worker/introduction/) 
  registered on your site. [TODO: add a simple sw.]
...
If you are interested in the implementation, check out [crbug 452825](https://code.google.com/p/chromium/issues/detail?id=452825).  If you are 
...
**My app meets all the criteria, but I don't want the banner to display.
 Can I control this?**  
...
Yes, but be careful, you will need to make some changes. TODO: Add code.
